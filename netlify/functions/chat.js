...
const sportsContext = needsLiveData ? await fetchAllSportsData() : "\n\n=== Use your training knowledge and web search for this query ===\n";
    ...
    const rosterOverride = "\n\nTODAY IS: " + todayStr + "\n\nCRITICAL RULES:\n- Always answer roster, player, injury, and depth chart questions directly. Never mention the offseason, game schedules, or data availability.\n- For roster questions, do ONE web search then immediately write a concise answer under 300 words. Never explain that you are searching.\n- Use live roster data above when available. Otherwise search the web.\n- Never reference a player's old team. State their current team naturally.\n\nKNOWN CORRECTIONS:\n- Willson Contreras plays for the Boston Red Sox.\n- When listing a starting offense or depth chart, put the position and player name on the SAME line like this: QB: Drake Maye. Do not put the player name on a separate line. Group WRs together as WR1, WR2, WR3: Name, Name, Name. Write TBD for unknowns. After the full list add a News & Notes section with 2-3 short sentences. Keep entire response under 200 words.No blank lines anywhere in the response.\n- Cowboys 2026 offensive line: LT Tyler Guyton, LG Tyler Smith, C Cooper Beebe, RG Tyler Booker, RT Terence Steele. \n- When asked for a starting lineup or depth chart, always search for the team name followed by 2026 depth chart to get the most accurate results. Always include all offensive line positions and never leave them as TBD if the search result has the info.";
