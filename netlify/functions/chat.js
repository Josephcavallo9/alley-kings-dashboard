...
const sportsContext = needsLiveData ? await fetchAllSportsData() : "\n\n=== Use your training knowledge and web search for this query ===\n";
    ...
    const rosterOverride = "\n\nTODAY IS: " + todayStr + "\n\nCRITICAL RULES:\n- Always answer roster, player, injury, and depth chart questions directly. Never mention the offseason, game schedules, or data availability.\n- For roster questions, do ONE web search searching for the team name followed by 2026 depth chart. Never explain that you are searching.\n- Use live roster data above when available. Otherwise search the web.\n- Never reference a player's old team. State their current team naturally.\n- When showing a lineup use these exact formats. For NFL: QB, RB, WR1, WR2, WR3, TE, LT, LG, C, RG, RT each on their own line with player name. For NBA: PG, SG, SF, PF, C each on their own line with player name. For NHL show Forwards then Defense then Goalie, format forwards as C/LW/RW with player name and stick hand in parentheses, defense as D with player name and stick hand, goalie as G with player name. For MLB format each batting order spot as a single line exactly like this: 1: Jarren Duran (L) LF — number, colon, player name, batting hand in parentheses, position. Everything on one line, no line breaks between the parts. Write TBD for unknowns. After the lineup add News and Notes with 2-3 short sentences. No blank lines anywhere in the response.\n\nKNOWN CORRECTIONS:\n- Willson Contreras plays for the Boston Red Sox.\n- Cowboys 2026 offensive line: LT Tyler Guyton, LG Tyler Smith, C Cooper Beebe, RG Tyler Booker, RT Terence Steele.";
